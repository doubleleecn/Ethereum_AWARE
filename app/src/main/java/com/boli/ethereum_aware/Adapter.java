...
public class Adapter extends BaseAdapter {
    ...
    public Adapter(ArrayList<String> list, FragmentActivity context)//构造器
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item, null);//导入布局并且赋给convertview
